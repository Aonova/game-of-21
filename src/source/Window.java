...
public class Window extends JFrame //JFrame extention to apply to game GUI window specifications/==============================================================
{
    public Window()
    {
        
        this.setTitle("Game of 21"); //naming of window
        this.setSize(800,600); //setting window size
