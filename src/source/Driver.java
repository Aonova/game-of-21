...
public class Driver //Main Class/=================================================================================================================
{
    ...
    public static ProcessStack processes; //The process execution stack, for loading consecutive threads
    public static ProcessList runningProcesses; //The list of running processes, to be able to reference and synchronize threads if needed (NOTE: HIDEOUSLY inefficient implementation)
    ...
    public static void createProcessHandlers()
    {
       processes = new ProcessStack();
       runningProcesses = new ProcessList();
    }
    ...
    public static void initializeGUIWindow()
    {
        try{
            ...
            masterPane = new JLayeredPane();
            masterWindow.add(masterPane);
            masterWindow.setBackground(new Color(0,0,0,0));
            
            JLabel backgroundImage = new JLabel(new ImageIcon(ImageIO.read(Driver.class.getResource("/Resource Files/finalBG.png"))));
            backgroundImage.setBounds(0, 0, backgroundImage.getIcon().getIconWidth(), backgroundImage.getIcon().getIconHeight());
