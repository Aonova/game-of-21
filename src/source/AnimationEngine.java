...
//    }
    ...
    public static void linearMove(JLabel ob, int x, int y, int ms) //simple motion animation method for JLabels, crudely handcrafted and pretty ineffiecient, TODO: subframe interpolation to make smoother. also, incorporate acceleration vectors.
    {
        try{
            JLabel object = ob;
