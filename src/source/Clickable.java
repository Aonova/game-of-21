            ...
            public void mouseReleased(MouseEvent e) //waiting for a mouse release
            {
                if ((self.isClicked == true) && (e.getX() > 0) && (e.getX() < self.getWidth()) && (e.getY() > 0) && (e.getY() < self.getHeight())) //checking if mouse was pressed and released on the area of the Clickable
                {
                        ...
                        new SimulProcess("CUSTOM process ContinueClicked", new CountDownLatch(1))
                        {
                            public void run()
                            {
                                try{
                                    ...
                                    Driver.processes.pushProcess(new SimulProcess(null, "process CloseEndGameMessage Synced", localLatch));
                    ...
                    if (self.getName().equals("Stand"))
                    {
                        ...
                        Driver.processes.pushProcess(new SimulProcess((Object)self,"animation StandFade"));
                        Driver.processes.pushProcess(new SimulProcess((Object)self.relatedObjs[0],"animation HitFade"));
                        Driver.processes.pushProcess(new SimulProcess((Object)self.relatedObjs[1],"animation FrameFade"));
                        Driver.processes.runProcesses();
                    ...
                    if (self.getName().equals("Hit"))
                    {
                        self.setName("Clicked");
                        ((Clickable)self.relatedObjs[0]).setName("Clicked");
                        Driver.processes.pushProcess(new SimulProcess((Object)self,"animation HitFade"));
                        Driver.processes.pushProcess(new SimulProcess((Object)self.relatedObjs[0],"animation StandFade"));
                        Driver.processes.pushProcess(new SimulProcess((Object)self.relatedObjs[1],"animation FrameFade"));
                        Driver.processes.pushProcess(new SimulProcess((Object)Driver.currentGame.playerHand, "process DRAWCARD")); 
                        Driver.processes.pushProcess(new SimulProcess(null, "process AcePrompt2"));
                        Driver.processes.runProcesses();
                    ...
                    if (self.getName().equals("Ace 1"))
                    {
                        self.setName("Clicked");
                        ((Clickable)self.relatedObjs[0]).setName("Clicked");
                        Driver.processes.pushProcess(new SimulProcess((Object)self,"animation Ace1Fade"));
                        Driver.processes.pushProcess(new SimulProcess((Object)self.relatedObjs[0],"animation Ace11Fade"));
                        Driver.processes.pushProcess(new SimulProcess((Object)self.relatedObjs[1],"animation FrameFade"));
                        Driver.processes.runProcesses();
                    ...
                    if (self.getName().equals("Ace 11"))
                    {
                        self.setName("Clicked");
                        ((Clickable)self.relatedObjs[0]).setName("Clicked");
                        Driver.processes.pushProcess(new SimulProcess((Object)self,"animation Ace11Fade"));
                        Driver.processes.pushProcess(new SimulProcess((Object)self.relatedObjs[0],"animation Ace1Fade"));
                        Driver.processes.pushProcess(new SimulProcess((Object)self.relatedObjs[1],"animation FrameFade"));
                        Driver.processes.runProcesses();
                    ...
                    {
                        self.setName("Clicked");     
                        Driver.processes.pushProcess(new SimulProcess(null,"animation BACKGROUNDANIM"));
                        Driver.processes.pushProcess(new SimulProcess((Object)self,"process INITIATEGAME"));
                        Driver.processes.pushProcess(new SimulProcess((Object)self,"animation JLabelFade"));
                        Driver.processes.runProcesses();
