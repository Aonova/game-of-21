...
//                                    new Location(null,900,300), new Location(null,900,150), new Location(null,900,0), new Location(null,600,0)      };
    ...
    {
        try{
            Driver.processes.pushProcess(new SimulProcess((Object)Driver.currentGame.playerHand,"process ClearHand", localLatch));
            Driver.processes.pushProcess(new SimulProcess((Object)Driver.currentGame.dealerHand,"process ClearHand", localLatch));
    ...
    private static void animateCardDispose(Card card, Location[] disposePoints) //code for that starting deck building animation
    {
        ...
        Driver.processes.pushProcess(new SimulProcess(card, disposePoints[random], "process DirectedCardDispose"));
        Driver.processes.runProcesses();
    }
    ...
    private static void animateCardFall(Card card, Location[] spawnPoints) //code for that starting deck building animation
    {
        ...
        Driver.processes.pushProcess(new SimulProcess("CUSTOM animation DECKCARDFALL") 
            {
                public void run()
                {
        ...
        Driver.processes.pushProcess(new SimulProcess(card.cardLabel,"animation CardBackFadeIn Synced"));
        Driver.processes.runProcesses();
    }
